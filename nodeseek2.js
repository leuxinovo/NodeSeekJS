      ...
      <div style="display: flex; justify-content: space-between; width: 100%; align-items: center;">
        <div style="display: flex; align-items: center; gap: 6px;">
          <a href="https://yxvm.com/" target="_blank">
            <img src="https://img.leu.pp.ua/file/图片/1753588260924_p6C6H5pY.png" 
                 alt="Logo 1" style="height: 16px;">
          </a>
          <span style="font-weight: bold; font-size: 1rem;">+</span>
          <a href="https://www.nodeseek.com/" target="_blank">
            <img src="https://img.leu.pp.ua/file/图片/1753589640446_kdMyXovu.png" 
                 alt="Logo 2" style="height: 16px;">
          </a>
        </div>
        <a href="https://github.com/NodeSeekDev/NodeSupport" 
           style="fill: #ccc; transition: fill 0.2s;" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="18px" height="18px" fill="white">
