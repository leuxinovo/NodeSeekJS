...
(function () {
  ...
  container.innerHTML = `
    <div style="
      ...
      background: linear-gradient(145deg, #0b1226, #1e2642);
    ...
    ">
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
        <div style="display: flex; align-items: center; gap: 8px;">
          <a href="https://yxvm.com/" target="_blank">
            <img src="https://img.leu.pp.ua/file/图片/1753588260924_p6C6H5pY.png" alt="YXVM" style="height: 18px;">
          </a>
          <span style="font-weight: bold; font-size: 1rem; opacity: 0.8;">+</span>
          <a href="https://www.nodeseek.com/" target="_blank">
            <img src="https://img.leu.pp.ua/file/图片/1753589640446_kdMyXovu.png" alt="NodeSeek" style="height: 18px;">
          </a>
        </div>
        <a href="https://github.com/NodeSeekDev/NodeSupport" target="_blank" style="display: flex; align-items: center; opacity: 0.85; transition: opacity 0.2s;">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="18" height="18" fill="white">
      ...
      <div style="margin-top: 14px;">
        <h3 style="font-size: 13px; margin: 0 0 6px 0; font-weight: 600; letter-spacing: 0.2px;">NodeSupport Project</h3>
        <p style="margin: 0; color: rgba(255,255,255,0.75); font-size: 11px; line-height: 1.4;">
          Provide free server sponsorship to high-quality blogs, channels, open-source projects, and popular apps.
        </p>
      </div>

      <!-- Footer Section -->
      <div style="margin-top: 12px; display: flex; justify-content: flex-end; color: rgba(255,255,255,0.65); font-size: 11px;">
        <span style="margin-right: 4px;">Support ID:</span>
        <span style="font-weight: 600; color: white;">${supportId}</span>
      </div>
    </div>
  `;
})();
